...
full.obs.Disease=full.obs.Disease.astype(object)
full.obs.Disease.loc[full.obs.Disease == 'Murid herpesvirus 4']='Herpesvirus'
full.obs.Disease.loc[full.obs.Disease == 'Severe Asthma']='Severe Asthma w Chlamydia'
full.obs.Disease.loc[full.obs.Disease == 'Severe Asthma w steroids']='Severe Asthma w Chlamydia w Steroids'
full.obs.Disease.loc[full.obs.Disease == 'Asthma w steroids']='Severe Asthma w Steroids'
full.obs.Disease.loc[full.obs.Disease == 'Asthma']='Severe Asthma'
...
custom_order = [
       ...
       'Control_Herpesvirus 4', 'Herpesvirus 4',
       'Control_Age - 24m', 'Age - 24m',  
       'Control_Covid', 'Covid', 'Control_Copd', 'Copd', 'Control_Fibrosis',
       'Fibrosis', 
       'Control_Severe Asthma','Severe Asthma',
       'Control_Severe Asthma w Chlamydia', 'Severe Asthma w Chlamydia', 
       'Control_Severe Asthma w steroids', 'Severe Asthma w steroids',
       'Control_Severe Asthma w Chlamydia w steroids',
       'Severe Asthma w Chlamydia w steroids', 
